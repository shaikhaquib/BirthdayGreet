...
import com.image.process.stickerview.util.WrappedDrawable;
...
public class TextSticker extends Sticker {
  ...
  public TextSticker(@NonNull Context context, @Nullable Drawable drawable) {
    ...
    if (drawable == null) {
      ...
      WrappedDrawable wrappedDrawable = new WrappedDrawable(this.drawable);
// set bounds on wrapper
      wrappedDrawable.setBounds(0,0,100,10);
      this.drawable = wrappedDrawable;
    }
...
// Scale it to 50 x 50
  ...
  @NonNull public TextSticker setTypeface(@Nullable Typeface typeface,int Style) {
