...
public class ClientProfileAdapter extends RecyclerView.Adapter<ClientProfileAdapter.ViewHolder> {
    Context context;
    String from;
    ...
    public ClientProfileAdapter(Context context, String from, ArrayList<DesignStudioBottomModel.ClientWiseMaterialList> materialList,int client_id) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.favimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<FavouriteModel> model= RetrofitClient
                        .getInstance().getApi().favourite(RetrofitClient.AppName,"Material", fav,id,client_id, SharedPrefManager.getInstance(context).userName());
        ...
        holder.binding.pic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onStickerSelected("client",holder.binding.imageurl.getText().toString());
