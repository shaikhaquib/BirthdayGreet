...
public class DesignElementAdapter extends RecyclerView.Adapter<DesignElementAdapter.ViewHolder> {
    Context context;
    String from;
    int client_id;
    ArrayList<DesignStudioBottomModel.ClientWiseMaterialList> materialList;

    public DesignElementAdapter(Context context, String from, ArrayList<DesignStudioBottomModel.ClientWiseMaterialList> materialList,int client_id ) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.favimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<FavouriteModel> model= RetrofitClient
                        .getInstance().getApi().favourite(RetrofitClient.AppName,"DesignElements", fav,id,client_id, SharedPrefManager.getInstance(context).userName());
        ...
        holder.binding.pic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                onStickerSelected("design",holder.binding.imageurl.getText().toString());
